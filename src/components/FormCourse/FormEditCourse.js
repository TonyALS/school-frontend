          ...
          <div className="card card-default">
            <div className="row justify-content-md-center">
              <div className="col-md-8">
                ...
                <Form autoComplete="off" className='text-center border border-light p-5 mb-6'>
                    <div className="card-body">
                      <div className="form-row">
                        <Field hidden name="id_course"/>
                        <div className="form-group col-md-6">
                          <label>Digite o nome do curso</label>
                          <Field type="text" className="form-control" placeholder='Nome do curso' 
                            name='course_name'
                            />
                          <ErrorMessage className="text-danger" component="span" name="course_name"/>
                        </div>

                        <div className="form-group col-md-6">
                        <label>Digite a portaria de autorização MEC</label>
                        <Field className="form-control" placeholder='Digite a portaria de autorização MEC' 
                          name='mec_authorization'/>
                        </div>

                        <div className="form-group col-md-6">
                            <label>Selecione o departamento</label>
                            <Field component="select" className="form-control" name='department_id'>
                          ...
                          <ErrorMessage className="text-danger" component="span" name="department_id"/>
                        </div>
                      </div>
                      ...
                      <div className="form-row">
                        ...
                        <div className="form-group col-md-6">
                          <Link to={'/courses'}>
                            <button className="btn btn-secondary btn-block btn my-5" 
                                disabled={isSubmitting} type='submit'>
                                Ir para listagem
                            </button>
                          </Link>
...
const FormEdit = withFormik({
  ...
  mapPropsToValues({ course_name, department_id, mec_authorization, id_course }) {
    return {
